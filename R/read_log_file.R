...
#'
#' @param log_txt vector object with log text lines
#'
...
#'
#' @param adj_log_txt vector object with formatted log text lines
#'
...
#'
#' @param adj_log_txt vector object with formatted log text lines
#' @param sect_info vector with nested sections (from `nest_sections()`)
#'
...
#'
#' @param file character path to a logrx file
#'
#' @return tibble that includes nested and parsed content
#'
#' @examples
#' \dontrun{
