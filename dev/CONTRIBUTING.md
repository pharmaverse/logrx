# Contributing to logrx

This outlines how to propose a change to logrx. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pharmaverse/logrx", fork = TRUE)`.
...
Please note that the logrx project is released with a [Contributor Code
of Conduct](https://pharmaverse.github.io/logrx/dev/CODE_OF_CONDUCT.md).
