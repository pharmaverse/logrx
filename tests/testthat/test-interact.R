test_that("set_log_element works", {
  ...
  expect_identical(
    getOption("log.rx")[["value"]],
    v
  )

  expect_identical(
    getOption("log.rx")[["list"]],
    l
  )
...
test_that("get_log_element works", {
  ...
  expect_identical(
    get_log_element("value"),
    v
  )

  expect_identical(
    get_log_element("list"),
    l
  )
