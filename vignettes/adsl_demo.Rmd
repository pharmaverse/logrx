...
to showcase certain features of the `timber` package's log file.

Users wishing to run a similar script will need to do the following:

* Install the timber package 
...
`timber` or use the `aexcute()` directly in a script or in the console to get a log file.
...
* Calls for getting SDTM datsets, e.g. `DM`, `EX`, `DS`
...
1.  Use the addin
2.  Use `timber::axecute("file.R")` directly in their script [See Vignette TODO]
3.  Use `timber::axecute("file.R")` in the console
4.  Use `timber::axecute("file.R")` in a batch script [See Vignette TODO]


## Log Output adsl.R

1. timber Metadata and User and File Information, of the log contains information about the version of timber used to create this log as well as user and file information.
