...
the `timber` package to generate a log upon the script execution for 
...
Finally, we build the risk-difference table, using the 
[`Typlr`](https://atorus-research.github.io/Tplyr/) package.
```{r}
