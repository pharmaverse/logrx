...
# Generating a log
The log can be generated in three ways:

* Using the `axecute()` function

* Using the `log_*()` functions

* Using the `logrx` addin
...
## `logrx` addin:
A log can be generated using the ```logrx``` addin. More information can be found in [logrx](https://atorus-research.github.io/logrx/index.html).
