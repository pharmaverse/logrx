...
Simple!  The timber package makes a log file for a R script!.  Below we have a short gif of
making a log file for a `adsl.R` script.  More details on the parts of the log script
are found in the [Get Started](https://atorus-research.github.io/timber/articles/timber.html) and
...
knitr::include_graphics("man/figures/timber.gif")
```
...
## Using timber
```timber``` can be used in a file or through scripting.  More information on how to use ```timber``` can be found in [Get Started](https://atorus-research.github.io/timber/articles/timber.html).
