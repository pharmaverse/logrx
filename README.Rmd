...
<!-- badges: start -->
[![R build status](https://github.com/atorus-research/logrx/workflows/R-CMD-check/badge.svg)](https://github.com/atorus-research/logrx/actions?workflow=R-CMD-check)
...
are found in the [Get Started](https://atorus-research.github.io/logrx/articles/logrx.html) and we have several vignettes that show specific use cases for using the package.



```{r img-with-knitr,  fig.show = 'animate', ffmpeg.format='gif', echo=FALSE, fig.align='center', out.height='120%'}

knitr::include_url("https://i.makeagif.com/media/12-13-2022/Ns_Lpy.gif", height = 650)
...
## Using logrx
```logrx``` can be used in a file or through scripting.  More information on how to use ```logrx``` can be found in [Get Started](https://atorus-research.github.io/logrx/articles/logrx.html).
